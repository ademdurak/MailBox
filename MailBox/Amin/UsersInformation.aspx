<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersInformation.aspx.cs" Inherits="MailBox.Admin.UsersInformation" %>
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="active" href="UsersInformation.aspx">Kullanıcılar</a></li>
                        </ul>
                    </li>
